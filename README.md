  ...
  "target": {
    "agent_alpine_jdk17": {
      ...
      "tags": [
        ...
        "docker.io/jenkins/agent:alpine3.21.3",
        "docker.io/jenkins/agent:latest-alpine3.21.3",
        "docker.io/jenkins/agent:alpine3.21.3-jdk17",
        "docker.io/jenkins/agent:latest-alpine3.21.3-jdk17"
      ],
      "target": "agent",
      "platforms": [
        "linux/amd64"
  ...
  "target": {
    "agent_alpine_jdk17": {
      ...
      "tags": [
        ...
        "docker.io/jenkins/agent:alpine-jdk17",
        "docker.io/jenkins/agent:latest-alpine-jdk17",
        "docker.io/jenkins/agent:3309.v27b_9314fd1a_4-3-alpine3.21.3-jdk17",
        "docker.io/jenkins/agent:3309.v27b_9314fd1a_4-3-alpine3.21.3",
        "docker.io/jenkins/agent:alpine3.21.3",
        "docker.io/jenkins/agent:latest-alpine3.21.3",
        "docker.io/jenkins/agent:alpine3.21.3-jdk17",
        "docker.io/jenkins/agent:latest-alpine3.21.3-jdk17"
